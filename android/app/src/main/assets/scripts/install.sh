...
echo '    "extensions.gallery.serviceUrl": "https://marketplace.visualstudio.com/_apis/public/gallery",' >> "$CONFIG_DIR/vscode-settings.json"
echo '    "extensions.gallery.itemUrl": "https://marketplace.visualstudio.com/items",' >> "$CONFIG_DIR/vscode-settings.json"
echo '    "extensions.gallery.resourceUrlTemplate": "https://{publisher}.gallery.vsassets.io/_apis/public/gallery/publisher/{publisher}/extension/{name}/{version}/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage",' >> "$CONFIG_DIR/vscode-settings.json"
